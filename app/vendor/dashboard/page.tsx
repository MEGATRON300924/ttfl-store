...
const LINKS = [
  {
    ...
    icon: Package,
    title: "My products",
    desc: "List, edit, and manage inventory",
  },
  {
    href: "/vendor/dashboard/orders",
    icon: ShoppingBag,
    title: "Orders",
    desc: "Fulfill orders from your store",
  },
  {
    href: "/vendor/dashboard/analytics",
    icon: BarChart3,
    title: "Analytics",
    desc: "Views, clicks, revenue, best sellers",
  },
  {
    href: "/vendor/dashboard/payouts",
    icon: Wallet,
    title: "Payouts",
    desc: "Balance and withdrawal history",
  },
  {
  ...
  {
    href: "/vendor/dashboard/promote",
    icon: Megaphone,
    title: "Promote",
    desc: "Feature a product or your store",
  },
  {
    href: "/vendor/dashboard/coupons",
    icon: Ticket,
    title: "Coupons",
    desc: "Discount codes for your store",
  },
  {
    href: "/vendor/dashboard/store-settings",
    icon: Settings,
    title: "Store settings",
    desc: "Manage your store profile and branding",
  },
];
    ...
    return (
      <div className="shell py-16 text-center">
        ...
        <p className="mt-1 text-sm text-graphite-600">
          ...
          <Link
            href="/sell"
            className="font-medium text-ember-600"
          >
            apply to sell
          </Link>
          .
        ...
        <div className="mt-4 flex items-start gap-3 rounded-card bg-gold-100 p-4">
          ...
          <div>
            ...
            <p className="mt-0.5 text-sm text-graphite-700">
              ...
              {vendor.status === "REJECTED" &&
                "Contact support if you'd like to appeal this decision."}
