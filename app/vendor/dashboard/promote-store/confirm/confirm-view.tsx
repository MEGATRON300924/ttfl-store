...
export function PromoteStoreConfirmView() {
  ...
  useEffect(() => {
    ...
    api
      .get(`/api/featured/stores/verify/${reference}`)
    ...
    <div className="shell py-16 text-center">
      ...
      {status === "success" && (
        <>
          ...
          <h1 className="mt-4 text-lg font-bold text-graphite-900">Store featured</h1>
          <p className="mt-1 text-sm text-graphite-600">Your store promotion is now live.</p>
          <Link
