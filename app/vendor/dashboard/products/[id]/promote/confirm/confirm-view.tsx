...
export function PromoteProductConfirmView() {
  ...
  useEffect(() => {
    ...
    api
      .get(`/api/featured/products/verify/${reference}`)
    ...
    <div className="shell py-16 text-center">
      ...
      {status === "success" && (
        <>
          ...
          <h1 className="mt-4 text-lg font-bold text-graphite-900">Product featured</h1>
          <p className="mt-1 text-sm text-graphite-600">Your promotion is now live.</p>
          <Link
