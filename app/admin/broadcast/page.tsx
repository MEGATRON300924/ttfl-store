...
const TEMPLATE_PRESETS: TemplatePreset[] = [
  {
    ...
    language: "en_US",
    body: "Hi {{1}}, your TTFL Store order {{2}} has been confirmed. Total: ₦{{3}}. We'll keep you updated as your order progresses.",
    parameters: ["Customer first name", "Order number", "Order total"],
  },
  {
    id: "order-shipped",
    name: "order_shipped",
    ...
    label: "Order shipped",
    language: "en_US",
    body: "Hi {{1}}, your TTFL Store order {{2}} has shipped and is now on its way. Track your order using the button below.",
    parameters: ["Customer first name", "Order number"],
  },
  {
    id: "out-for-delivery",
    ...
    language: "en_US",
    body: "Your TTFL Store order {{1}} is out for delivery. Please keep your phone available so the delivery rider can reach you.",
  ...
  },
  {
    ...
    language: "en_US",
    body: "Your TTFL Store order {{1}} has been delivered successfully. Thank you for shopping with TTFL Store!",
    parameters: ["Order number"],
  },
  {
    id: "payment-failed",
    ...
    language: "en_US",
    body: "We couldn't confirm the payment for TTFL Store order {{1}}. Please check your payment method and try again.",
    parameters: ["Order number"],
  },
  {
    id: "admin-new-order",
    ...
    language: "en_US",
    body: "New TTFL Store order {{1}} from {{2}} for ₦{{3}}. Please review the order in the admin dashboard.",
    parameters: ["Order number", "Customer name", "Order total"],
  },
  {
    id: "admin-vendor-application",
    name: "new_vendor_application",
    audience: "ADMINS",
    label: "New vendor application",
    language: "en_US",
    body: "A new vendor application has been submitted. Store: {{1}}. Applicant: {{2}}. Please review it in the admin dashboard.",
    parameters: ["Store name", "Applicant name"],
  },
  {
    id: "admin-payment-alert",
    name: "admin_payment_alert",
    audience: "ADMINS",
    label: "Payment alert — Admin",
    language: "en_US",
    body: "Payment failed for TTFL Store order {{1}}. Please review the order and payment status in the admin dashboard.",
    parameters: ["Order number"],
  },
  {
    id: "announcement-customer",
    name: "store_announcement",
    audience: "CUSTOMERS",
    label: "General announcement",
    language: "en_US",
    body: "Hi {{1}}, {{2}} — TTFL Store",
    parameters: ["Customer first name", "Announcement text"],
  },
];
...
export default function BroadcastPage() {
  ...
  async function submit(event: FormEvent) {
    ...
    try {
      ...
      const whatsappStatus = whatsapp ? ` WhatsApp: ${result.whatsappSent} sent, ${result.whatsappFailed} failed, ${result.whatsappSkipped} without phone.` : "";
      setStatus(`Broadcast created for ${result.recipientCount} users.${whatsappStatus}`); setTitle(""); setMessage(""); setSubject(""); await load();
  ...
  async function sendDedicatedWhatsApp(event: FormEvent) {
    ...
    setWhatsappStatus("Sending WhatsApp notification...");
    ...
    try {
      ...
      setWhatsappStatus(error instanceof Error ? error.message : "WhatsApp notification failed");
