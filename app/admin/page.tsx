...
const LINKS = [
  { href: "/admin/vendors", icon: Users, title: "Vendor applications", desc: "Approve, reject, or suspend vendors" },
  { href: "/admin/products", icon: Package, title: "Product moderation", desc: "Suspend or reinstate listings" },
  ...
  { href: "/admin/featured", icon: Megaphone, title: "Featured listings", desc: "Active paid promotions" },
  { href: "/admin/support", icon: MessageCircle, title: "Support inbox", desc: "Customer conversations" },
  { href: "/admin/audit-logs", icon: FileText, title: "Audit logs", desc: "Sensitive admin action history" },
  { href: "/admin/email-logs", icon: Mail, title: "Email logs", desc: "Delivery status for queued emails" },
];
