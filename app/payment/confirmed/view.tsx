...
export default function PaymentConfirmedView() {
  const searchParams = useSearchParams(); const cart = useCart(); const [state, setState] = useState<"checking" | "success" | "failed">("checking"); const [orderNumber, setOrderNumber] = useState("");
