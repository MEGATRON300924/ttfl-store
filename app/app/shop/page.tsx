...
async function getCategories() {
  try {
    return await api.get<ApiCategory[]>("/api/categories");
  } catch {
    return [];
  }
}
...
export default async function ShopPage({
  ...
  return (
    <div className="shell py-8">
      ...
      {/* Bottom information */}
      <div className="mt-8 border-t border-graphite-100 pt-5 text-center text-xs text-graphite-500">
        Showing up to {limit} products per page
      </div>
    </div>
  );
}
